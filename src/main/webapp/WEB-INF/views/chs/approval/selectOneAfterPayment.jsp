...
<div class="chs-custom">
	...
	<div class="right-container">
        ...
        <table class="approval-table">
            ...
            <tr>
                <th>지출금액</th>
                <td colspan="5" id="totalAmount">${approval.afterPayment.payAmount }</td>
            </tr>
            <tr>
                <th>제목</th>
            ...
            <tr>
                <th>지출건</th>
                <td id="input-td" colspan="5"><input type="text" name="apvCase"  value="${approval.afterPayment.payCase }" required></td>
            </tr>
            <tr>
                <th>지출 날짜</th>
                <td id="input-td" colspan="5"><input type="date" name="payDate" value="${approval.afterPayment.payDate }" required></td>
            </tr>
            <tr>
                <th>첨부파일</th>
        ...
        <table class="detail-table" id="detail-table">
            <tr>
           	...
           	<c:if test="${approval.afterPayment.paymentList != null }">
           	<%	int count = 1; %>
            	<c:forEach var="pl" items="${approval.afterPayment.paymentList }">
		            <tr>
	    	            <td>
	    	            	<%=count++ %>
	    	            </td>
	...
	<script>
		const loginMemberSign = "${loginMember.oriname}";
