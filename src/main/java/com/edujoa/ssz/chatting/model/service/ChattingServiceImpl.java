...
public class ChattingServiceImpl implements ChattingService {
	...
	@Override
	public List<ChatRecord> getMyChatRecords(String roomId) {
		// TODO Auto-generated method stub
		return dao.getMyChatRecords(session, roomId);
	}

	@Override
	public Employee getReceiverInfo(Map<String, Object> param) {
		// TODO Auto-generated method stub
